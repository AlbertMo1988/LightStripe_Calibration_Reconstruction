...
public:
	...
	void getCrossCamera(CvPoint3D32f &output_point,float &a1, float &a2, float &a3, float &OP, CvPoint3D32f &cross_point_c, double squareSize);
	void getCrossCamera2(CvPoint3D32f &output_point, float &a1, float &a2, float &a3, float &OP, CvPoint3D32f &cross_point_c, double d);
